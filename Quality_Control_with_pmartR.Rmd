...
## Update emeta of pepData
### Generate proteoform df
proteoforms_emeta <- dplyr::bind_rows(proteoforms)

### Adjust for class differences
norm_data$e_meta$Protein <- as.character(norm_data$e_meta$Protein)
norm_data$e_meta$Mass_Tag_ID <- as.character(norm_data$e_meta$Mass_Tag_ID)

### Join data
norm_object2 <- dplyr::left_join(norm_data$e_meta, proteoforms_emeta)
tidyr::unite(norm_object2, "Protein", "Protein", "proteoformID")
